...
item_notifications = {
    ...
    "Coconut": [],
    "Cactus": [],
    "Cacao": ["@eeevee2", "@thatkidAki", "@kamonohashi12"],
    "Dragon Fruit": [],
    "Grape": ["@kamonohashi12"],
    "Mushroom": ["@thatkidAki"],
    "Beanstalk": ["@eeevee2", "@thatkidAki", "@kamonohashi12"],
    "Watering Can": [],
    "Trowel": [],
    "Favorite Tool": [],
    "Basic Sprinkler": [],
    "Godly Sprinkler": ["@thatkidAki", "@kamonohashi12"],
    "Advanced Sprinkler": ["@thatkidAki"],
    "Master Sprinkler": ["@eeevee2", "@thatkidAki", "@kamonohashi12"],
