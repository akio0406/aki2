...
item_notifications = {
    ...
    "Watermelon": [],
    "Apple": [],
    "Pepper": ["@thatkidAki", "@zyrillkyato1", "@eeevee2", "@Kylealwyn", "@Shinshong69"],
    "Mango": [],
    "Daffodil": [],
    "Pumpkin": [],
    "Corn": [],
    "Coconut": [],
    "Cactus": [],
    "Cacao": ["@eeevee2", "@thatkidAki", "@kamonohashi12", "@zyrillkyato1", "@Kylealwyn"],
    "Dragon Fruit": [],
    "Grape": ["@kamonohashi12", "@Shinshong69"],
    "Mushroom": ["@thatkidAki", "@zyrillkyato1"],
    "Beanstalk": ["@eeevee2", "@thatkidAki", "@kamonohashi12", "@zyrillkyato1", "@Kylealwyn"],
    "Watering Can": [],
    "Trowel": [],
    "Favorite Tool": [],
    "Basic Sprinkler": ["@supremo_deprimo"],
    "Godly Sprinkler": ["@thatkidAki", "@kamonohashi12", "@supremo_deprimo", "@eeevee2", "@Shinshong69"],
    "Advanced Sprinkler": ["@thatkidAki", "@supremo_deprimo", "@eeevee2"],
    "Master Sprinkler": ["@eeevee2", "@thatkidAki", "@kamonohashi12", "@zyrillkyato1", "@supremo_deprimo", "@Kylealwyn", "@Shinshong69"],
    "Lightning Rod": ["@eeevee2", "@thatkidAki", "@Kylealwyn", "@Shinshong69"],
    "Recall Wrench": [],
    "Bug Egg": [],
    "Mythic Egg": []
}
